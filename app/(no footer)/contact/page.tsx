    ...
    <main ref={containerRef} className="px-10 lg:px-30">
      <div className="lg:px-64 pb-40">
        <div className="flex">
          <div
            style={{ marginTop: "10%" }}
            className="self-start select-none flex flex-col items-start"
          >
            <span className="text-6xl sm:text-8xl p-4">Learn More</span>
            <span
              style={{ paddingLeft: "20px" }}
              className="self-start text-6xl sm:text-8xl"
            >
              About Me
            </span>
          </div>
        ...
        <section className="flex pt-20 flex-col lg:flex-row">
          <form ref={formRef} className="lg:w-3/5" onSubmit={onSubmit}>
            <section>
              <div
                className="border-top py-6 flex transition-all"
                style={{
                  height: "150px",
              ...
              >
                <div
                  className={
                    nameColor +
                    " text-2xl flex items-start pt-1 w-20 transition-all"
                  }
                >
                  01
                </div>
                <div className="flex flex-col w-full ">
                  <h1
                    className={
                      "px-5 font-bold grow mb-1 transition-all text-lg sm:text-3xl " +
                      nameColor
                    }
                  >
                    {"What's your name?"}
                  ...
                  <input
                    ...
                    className="px-5 bg-transparent text-2xl outline-none"
                    name="user_name"
            ...
            <section>
              <div
                className="border-top py-6 flex text-lg sm:text-3xl"
                style={{
                  height: "150px",
                  borderTop: "1px white solid",
                  borderBottom: "1px white solid",
            ...
            <section>
              <div
                className="border-top py-6 flex"
                style={{ height: "300px", borderTop: "1px white solid" }}
              >
                <div
                  className={
                    "text-2xl flex items-start pt-1 w-20 transition-all " +
                ...
                <div className="px-5 flex flex-col w-full">
                  <h1
                    className={
                      "font-bold grow mb-1 transition-all  text-lg sm:text-3xl " +
                      messageColor
                    }
                  >
                    {"Your message"}
                  ...
                  <textarea
                    ...
                    className="px-5 bg-transparent  text-2xl outline-none grow"
                    placeholder="Hello Simon... *"
                    value={messageValue}
                    name="message"
                  />
                </div>
            ...
            <div className="flex sm:hidden w-full py-24 items-center grow">
              <button
                className="bg-tt h-16 w-full rounded-full cursor-pointer"
                type="submit"
              >
                <TransitionLink
          ...
          <section className="grow sm:px-20">
            ...
            <div className="mb-3">
              ...
              <div className="text-2xl">
                <a
                  className="underline"
                  href="https://linkedin.com/in/simon-dao"
                >
            ...
            <div className="mb-3">
              ...
              <div className="text-2xl">
                <a
                  className="underline"
                  href="https://uw.joinhandshake.com/profiles/44602458"
                >
                  https://uw.joinhandshake
                </a>
              </div>
            </div>
          </section>
