            ...
            <div className="px-10 lg:px-24">
                ...
                <article>
                    ...
                    <p className="text-xl leading-relaxed mb-6">
                        Hello! My name is Simon Dao, and I’m glad you’re here taking the time
                        to get to know me a little better. As of writing this, it has been{" "}
                    ...
                    <p className="text-xl leading-relaxed">
                        My programming journey started when I was 14, when I realized I could
                        turn the ideas in my head into things that actually worked. I began
                        with small games and simple scripts—usually breaking more than I
                        built—but every mistake taught me something new. That curiosity never
                        faded. Over time, it turned into a real appreciation for how software
                        can solve problems, help people, and bring ideas to life. What began
                        as a hobby eventually became the foundation for my education, my
                        career interests, and the work in this portfolio.
                    </p>
