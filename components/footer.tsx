    ...
    <footer className="sm:hidden grow pt-10 bg-qt text-white flex flex-col px-10">
      ...
      <div className="w-full flex-col flex xs:flex-row pb-5">
        <div>
          ...
          <div className="text-sm sm:text-3xl font-bold color-white mb-2">
            {localTime}
          </div>
        </div>
        ...
        <div>
          ...
          <div className="font-bold color-white flex">
            ...
            <Magnetic>
              <a href="https://uw.joinhandshake.com/profiles/44602458">
                Handshake
              </a>
            </Magnetic>
            <div className="w-6"></div>
...
function NormalView() {
  ...
  return (
    <footer
      className="grow hidden sm:flex flex-col bg-qt text-white"
      style={{ padding: "0 15%" }}
    >
      <div className="flex">
        <div
        ...
        >
          <span style={{ fontSize: "90px" }}>Get To</span>
          <span style={{ fontSize: "90px" }}>Know Me</span>
        </div>
        <Image
