      ...
      blurbs: [
        {
          ...
          blurb: `During the summer of 2025, I had the incredible opportunity to work as a Software Engineer Intern at the Smart City Research Lab in Bamberg, Germany.
                    This experience gave me an opportunity to work on a project that directly impacts the lives of people in the city. 
                    `,
        ...
        {
          title: "My Project",
          blurb: `My project for the summer was to develop a centralized storage system to store and manage data from various sensors deployed throughout the city.
                    Since each sensor type was developed by a different team, the data was stored in different formats and locations.
                    For this project, I ran a server that had sensorThings API endpoints that allowed the city to query the data from each sensor. From there, 
                    I created data pipelines that would take the data from each sensor and store it in a centralized database.
                    `,
          img: "",
          imgLink: "",
        },
      ...
      blurbs: [
        {
          ...
          blurb: `Computing for all is a non-profit organization that aims to provide digital skills training to underrepresented communities.
        ...
        {
          blurb: `From there, I was able to work on a variety of projects, including overhauling CFA's student database to provide more accurate information
    ...
    <div>
      {modalVisible && (
        <div
          ref={modalOuter}
          onClick={closeModal}
          className="cursor-pointer fixed inset-0 flex items-center justify-center z-40 bg-gray-900 bg-opacity-75"
        >
          <div
            ref={modalInner}
            className="bg-qt h-3/4 w-3/4 py-3 rounded-lg shadow-lg flex flex-col sm:px-20"
